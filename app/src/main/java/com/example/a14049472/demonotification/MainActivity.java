package com.example.a14049472.demonotification;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNotify2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bigText.bigText("This is one big text" + " - A quick brown fox jump over a lazy brown dog " + "\nLorem ipsum dolor sit amet, sea eu quod des");
                ...
                // this replaces the existing notification with same ID
                notificationManager.notify(notificationID, n);
                finish();
